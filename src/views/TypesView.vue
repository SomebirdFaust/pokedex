...
<template>   
  <div class="mx-8 lg:mx-16">   
    ...
    <div class="flex flex-col items-center space-y-4">    
      <input type="text" class="bg-white border border-slate-800 rounded-md p-2" placeholder="Nom ou ID du type" v-model="searchQuery"/>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-4">
      <div v-for="type in filteredList()" :key="type.id" class="border border-gray-300 p-4 rounded-lg shadow-lg bg-white">
        ...
        <img :src="type.sprites" class="w-40 h-auto rounded-lg">
